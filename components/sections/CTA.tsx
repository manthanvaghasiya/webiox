      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
            {/* Background Accents */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#1a7097]/20 blur-[80px] rounded-full mix-blend-screen" />
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
              <h2 className="text-3xl md:text-5xl font-bold text-[#F9FAFB] mb-6 tracking-tight leading-tight">
                Ready to Build Something <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-[#1a7097]">Amazing?</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#1a7097] text-[#F9FAFB] font-semibold hover:bg-[#1a7097]/90 transition-all shadow-lg hover:shadow-[#1a7097]/30"
                  >
                    Start Your Project
                ...
                <Link href="/services">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-full border-2 border-gray-600 text-[#F9FAFB] font-semibold hover:border-[#1a7097] hover:bg-[#1a7097]/5 transition-all"
                  >
                    Explore Services
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </motion.button>
