...
import { Layout, CheckCircle2, Zap, Shield, Monitor } from 'lucide-react';
...
export default function EnterpriseWebJourney() {
  ...
  useEffect(() => {
    ...
    const runSequence = async () => {
      while (isActive) {
        ...
        await new Promise(r => setTimeout(r, 3500)); // Admire the UI for 3.5s before resetting
      }
    };
  ...
  return (
    <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] min-h-[450px] sm:min-h-[400px] bg-[#030712] rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(6,182,212,0.05)_0%,transparent_50%)] pointer-events-none" />
      ...
      >
        ...
        {/* ================= DESKTOP WINDOW ================= */}
        <motion.div 
          className="relative z-10 w-[95%] md:w-[90%] aspect-[4/3] sm:aspect-[16/10] min-h-[400px] sm:min-h-0 bg-slate-900/90 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-[0_40px_100px_rgba(0,0,0,0.8)] border border-slate-700/50 overflow-hidden flex flex-col mx-auto"
          style={{ 
